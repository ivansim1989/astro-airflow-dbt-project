...
S3_FILE_PATH = "s3://ivan-astrosdk/orders_data_header.csv"
S3_CONN_ID = "aws_default"
SNOWFLAKE_CONN_ID = "snowflake_default"
SNOWFLAKE_ORDERS =  "orders_table"
SNOWFLAKE_FILTERED_ORDER = "filtered_table"
...
def join_orders_customers(filtered_orders_table: Table, customer_table: Table):
    return """"SELECT c.customer_id, customer_name, order_id, purchase_data, amount, type
    FROM {{filtered_orders_table}} f JOIN {{customers_table}} c
    ON f.customer_id = c.customer"""
